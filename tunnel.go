...
var tunnelCmd = &cobra.Command{
	...
	RunE: func(_ *cobra.Command, args []string) error {
		...
		return emit(&Report{Root: root, Tags: resolvedTags(), Findings: scanReExportTunnel(pkgs)})
	},
}
...
func scanReExportTunnel(pkgs []*packages.Package) []Finding {
...
// alphabetically. Used by the Internal Re-Export Tunnel detector to
// identify the single deeper package a tunnel re-exports from.
